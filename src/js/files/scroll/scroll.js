...
// 	let isHeroInViewport = false; // Флаг, указывающий на то, находится ли элемент .hero во вьюпорте
// 	// Добавляем прокрутку по событию wheel
// 	document.addEventListener("wheel", scrollNavigationAction, { passive: false });
...
// 	function scrollNavigationAction(e) {
//     if (isHeroInViewport) {
//         const heroElement = document.querySelector('.hero[data-goto]');
//         if (heroElement) {
//             const gotoLinkSelector = heroElement.dataset.goto ? heroElement.dataset.goto : '';
//             const noHeader = heroElement.hasAttribute('data-goto-header') ? true : false;
//             const gotoSpeed = heroElement.dataset.gotoSpeed ? heroElement.dataset.gotoSpeed : 500;
//             const offsetTop = heroElement.dataset.gotoTop ? parseInt(heroElement.dataset.gotoTop) : 0;
//             const direction = chooseDirection(e.deltaY);
//             if (direction === 1) {
//                 gotoBlock(gotoLinkSelector, noHeader, gotoSpeed, offsetTop);
//                 e.preventDefault();
//             }
...
// }
// 	function checkHeroInViewport() {
// 			const heroElement = document.querySelector('.hero');
// 			if (heroElement) {
// 					const rect = heroElement.getBoundingClientRect();
// 					isHeroInViewport = rect.top >= 0 && rect.bottom <= window.innerHeight;
// 			}
// 	}

// 	// Проверяем положение элемента .hero во вьюпорте при загрузке страницы и при прокрутке
// 	window.addEventListener("DOMContentLoaded", checkHeroInViewport);
// 	window.addEventListener("scroll", checkHeroInViewport);
