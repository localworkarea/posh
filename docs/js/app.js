 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-main")) new Swiper(".slider-main", {
                modules: [ freeMode ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".article__slider")) new Swiper(".article__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".approach__slider")) new Swiper(".approach__slider", {
                modules: [ Autoplay, freeMode ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        function initSlideObserver() {
            ...
            document.querySelector(".nav-serv__slider").swiper;
            const navSlides = document.querySelectorAll(".nav-serv__slide");
            let observerOptions;
            if (window.innerWidth > 480.98) observerOptions = {
                root: null,
            ...
            const observer = new IntersectionObserver(((entries, observer) => {
                entries.forEach((entry => {
                    ...
                    } else entry.target.classList.remove("_view");
                }));
            }), observerOptions);
...
***************************************************************************** */
        ...
        function checkScreenWidth() {
            if (window.innerWidth < 480) {
                if (!flsModules.gallery) initializeGalleries();
            } else if (flsModules.gallery) destroyGalleries();
        }
        checkScreenWidth();
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (heroBg) {
                const addHoverClass = () => {
                    if (window.innerWidth > 30.06125 * parseFloat(getComputedStyle(document.documentElement).fontSize)) heroBg.classList.add("hover");
                };
                const removeHoverClass = () => {
                    if (window.innerWidth > 30.06125 * parseFloat(getComputedStyle(document.documentElement).fontSize)) heroBg.classList.remove("hover");
                };
            ...
            if (btnMaskElements.length > 0) btnMaskElements.forEach((function(btnMaskElement) {
                ...
                stepsAElements.forEach((function(stepsAElement) {
                    var stepsAObserver = new MutationObserver((function(mutations) {
                        mutations.forEach((function(mutation) {
                            if (stepsAElement.classList.contains("_watcher-view")) setTimeout((function() {
                                typed.start();
                    ...
                    stepsAObserver.observe(stepsAElement, {
                        attributes: true,
            ...
            if (clientsItems.length > 0) clientsItems.forEach((item => {
            ...
            if (videoContainers.length > 0) videoContainers.forEach((container => {
            ...
            if (navElement) {
                function checkNavPosition() {
                    if (navElement) {
                        ...
                        if (rect.top >= 0) navElement.classList.add("_sticky"); else navElement.classList.remove("_sticky");
                    }
                }
            ...
            if (ourServ) {
                function checkOurServPosition() {
                    ...
                    if (topPosition <= 0) navElement.classList.add("_top-mb"); else if (topPosition > 60) navElement.classList.remove("_top-mb");
                }
